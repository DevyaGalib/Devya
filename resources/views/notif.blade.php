    ...
    <div class="container">
      ...
      <div class="row g-0">
        <div class="col-12 mt-5">
            <div class="text-center">
                <h3>Terima Kasih, Pendaftaran Anda Sudah Kami Terima Untuk Melengkapi Berkas Silahkan Login Terlebih Dahulu Menggunakan Email & Password Yang Sudah Di Daftarkan</h3>
              </div>
              <div class="text-center">
